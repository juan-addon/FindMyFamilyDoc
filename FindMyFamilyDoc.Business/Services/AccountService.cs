...
namespace FindMyFamilyDoc.Business.Services
{
	public class AccountService : IAccountService
	{
		...
		private async Task SendEmailConfirmationAsync(string email, string userId, string emailConfirmationToken)
		{
			...
			var confirmationLink = $"https://findafamily.vercel.app/auth/confirm-email?userId={userId}&token={emailConfirmationToken}";
        ...
        <body>
            <div class='container'>
                ...
                <a class='button' href='{confirmationLink}'>Confirm Email Address</a>
		...
		private async Task SendPasswordResetToken(string email, string userId, string passwordResetToken)
		{
			...
			var resetLink = $"https://findafamily.vercel.app/auth/reset-password?userId={userId}&token={passwordResetToken}";
        ...
        <body>
            <div class='container'>
                ...
                <p>We've received a request to reset the password associated with this email address. If you made this request, please follow the instructions below. If you did not request to have your password reset, you can safely ignore this email.</p>
