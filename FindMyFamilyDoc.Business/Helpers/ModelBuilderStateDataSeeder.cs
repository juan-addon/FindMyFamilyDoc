	...
	public static class ModelBuilderStateDataSeeder
	{
		public static void Seed(this ModelBuilder modelBuilder)
		{
			...
			modelBuilder.Entity<Language>().HasData(
				...
				new Language { Id = 11, Name = "Portuguese" },
				new Language { Id = 12, Name = "Arabic" },
				new Language { Id = 13, Name = "Swedish" },
				new Language { Id = 14, Name = "Danish" },
				new Language { Id = 15, Name = "Finnish" },
				new Language { Id = 16, Name = "Norwegian" },
				new Language { Id = 17, Name = "Polish" },
				new Language { Id = 18, Name = "Hungarian" },
				new Language { Id = 19, Name = "Greek" },
				new Language { Id = 20, Name = "Hebrew" },
				new Language { Id = 21, Name = "Turkish" },
				new Language { Id = 22, Name = "Hindi" },
				new Language { Id = 23, Name = "Bengali" },
				new Language { Id = 24, Name = "Urdu" },
				new Language { Id = 25, Name = "Punjabi" },
				new Language { Id = 26, Name = "Indonesian" },
				new Language { Id = 27, Name = "Thai" },
				new Language { Id = 28, Name = "Tagalog" },
				new Language { Id = 29, Name = "Vietnamese" },
